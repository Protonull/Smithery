...
public final class Forge implements InventoryHolder {
    ...
    public void saveForge() {
        ForgeUtils.getFurnaceNBT(getFurnace()).setCompound(Forge.FORGE_KEY.asString(), toNBT());
    }
    ...
    public @NotNull NBTCompound toNBT() {
        ...
        // Save inventory
        nbt.setCompound(INVENTORY_KEY, Utilities.inventoryToNBT(getInventory()));
        return nbt;
    }
    ...
    public void fromNBT(final @NotNull NBTCompound nbt) {
        ...
        // Load inventory
        final NBTCompound inventoryNBT = nbt.getCompound(INVENTORY_KEY);
        if (ingredientNBT != null) {
            Utilities.inventoryFromNBT(getInventory(), inventoryNBT);
        }
        else {
            getInventory().clear();
        }
